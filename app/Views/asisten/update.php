...
<div class="jumbotron">
    <h1 class="display-4">Update Asisten Praktikum</h1>
    <p class="lead">Update data di dalam database</p>
    <hr class="my-4">
    <form method="post" action="/asisten/update">
        ...
        <button class="btn btn-primary" name="btnsubmit" value="simpan" type="submit"><i class="bi bi-arrow-clockwise"></i>
            Simpan</button>
    </form>
</div>
<?= $this->endSection(); ?>